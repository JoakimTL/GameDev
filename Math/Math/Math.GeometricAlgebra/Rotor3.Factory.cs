...
{
	/// <summary>
	/// Creates a rotor from a normalized axis vector and an angle.
	/// </summary>
	public static Rotor3<TScalar> FromNormalizedAxisAngle<TScalar>(in Vector3<TScalar> axisNormalized, TScalar angle) where TScalar : unmanaged, IFloatingPointIeee754<TScalar>
	{
	...
	public static Rotor3<TScalar> FromAxisAngle<TScalar>(in Vector3<TScalar> axis, TScalar angle) where TScalar : unmanaged, IFloatingPointIeee754<TScalar>
	{
		...
		return FromNormalizedAxisAngle(axisNormalized, angle);
	}
	...
	public static bool TryFromAxisAngle<TScalar>(in Vector3<TScalar> axis, TScalar angle, out Rotor3<TScalar> result) where TScalar : unmanaged, IFloatingPointIeee754<TScalar>
	{
		...
		result = FromNormalizedAxisAngle(axisNormalized, angle);
		return true;
	}
