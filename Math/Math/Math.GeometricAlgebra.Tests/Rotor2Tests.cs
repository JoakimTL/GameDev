...
public sealed class Rotor2Tests
{
	...
	{
		Rotor2<double> a = new(1, 2);

		Rotor2<double> expected = new(1, 0);
		bool success = a.TryGetInverse(out Rotor2<double> inverse);

		Rotor2<double> result = a * inverse;
	...
	{
		Rotor2<double> a = new(0, 0);

		bool success = a.TryGetInverse(out Rotor2<double> inverse);

		Assert.That(success, Is.False);
		Assert.That(inverse, Is.EqualTo(default(Rotor2<double>)));
	}
