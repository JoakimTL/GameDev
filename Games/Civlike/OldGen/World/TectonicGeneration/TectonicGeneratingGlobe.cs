...
//		this.InsolationProvider = new InsolationProvider( this, DefaultInsolation.GetDailyMeanInsolation );
//	}
...
//	public InsolationProvider InsolationProvider { get; set; }
...
//	public IReadOnlyList<IReadOnlyList<Face<TectonicFaceState>>> NonOceanTectonicFaceClustersBySlopeNeighbourhood => this.Latitudes.Select( lat => this.TectonicFaces.Where( face => face.LatitudeId == lat.Rads ).ToList() ).ToList();
...
//		this.TectonicFaces = [ .. this.Faces.OfType<Face<TectonicFaceState>>() ];
//		this.FaceTree.Clear();
//		foreach (Face<TectonicFaceState> face in this.TectonicFaces)
//			this.FaceTree.Add( face );
//	}

//	public void UpdateFaceLists() {
//		this.NonOceanTectonicFacesByElevationMean = [ .. this.TectonicFaces
//			.Where( face => !face.IsOcean )
//			.OrderByDescending( face => face.State.BaselineValues.ElevationMean ) ];
//		List<IGrouping<float, Face<TectonicFaceState>>> latitudeGroups = this.TectonicFaces
...
//			foreach (Face<TectonicFaceState>? face in latitudeGroups[ i ]) 				face.LatitudeId = i;
//		}
//		this.Latitudes = latitudeArray;
//	}
...
//		return (float) (this.Radius * angle);
//	}

//	protected override bool InternalDispose() {
//		this.InsolationProvider.Dispose();
//		return true;
//	}
//}
