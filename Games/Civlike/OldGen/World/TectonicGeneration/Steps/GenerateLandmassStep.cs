...
//using OldGen.World.GenerationState.Steps;
//using OldGen.World.NoiseProviders;
...
//		TectonicPlateGenerator tectonicRegionGenerator = new( new( globe.SeedProvider.Next() ), parameters.TectonicParameters.PlateCountBase + (int) float.Round( (globe.SeedProvider.NextSingle() * 2 - 1) * parameters.TectonicParameters.PlateCountVariance ), 0.01f,  parameters.TectonicParameters.PlateHeight - parameters.TectonicParameters.PlateHeightVariance,  parameters.TectonicParameters.PlateHeight + parameters.TectonicParameters.PlateHeightVariance );
