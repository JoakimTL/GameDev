...
//		this.Center = ((this.VectorA + this.VectorB + this.VectorC) / 3f).ToNumerics();
//		this.CenterNormalized = Vector3.Normalize( this.Center );
...
//		this.Bounds = AABB.Create( [ this.VectorA, this.VectorB, this.VectorC ] );
//	}
