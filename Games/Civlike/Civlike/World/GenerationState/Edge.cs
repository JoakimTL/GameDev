...
public sealed class Edge( int id, Vertex vertexA, Vertex vertexB ) {
	...
	public Face FaceA => this._faceA ?? throw new InvalidOperationException( "No face A exists." );
	public Face FaceB => this._faceB ?? throw new InvalidOperationException( "No face B exists." );
