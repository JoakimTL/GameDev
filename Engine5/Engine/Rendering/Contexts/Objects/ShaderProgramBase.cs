...
public abstract class ShaderProgramBase : Identifiable, IDisposable
{
    ...
    public IReadOnlyDictionary<ShaderType, ShaderSource> Sources => _sources;

    protected ShaderProgramBase(bool separable = true)
    {
        Separable = separable;
        _sources = new Dictionary<ShaderType, ShaderSource>();
    ...
    public void Dispose()
    {
        foreach (KeyValuePair<ShaderType, ShaderSource> kvp in _sources)
