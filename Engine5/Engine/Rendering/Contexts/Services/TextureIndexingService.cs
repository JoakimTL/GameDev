...
public sealed class TextureIndexingService : Identifiable, IContextService, IUpdateable, IInitializable, IDisposable
{
    ...
    public TextureIndexingService(VertexBufferObjectService vertexBufferObjectService)
    {
        _lowestOpenIndex = 0;
    ...
    {
        //TODO fix!
        _ssbo = new(_vertexBufferObjectService.ShaderStorage, "TextureAddresses", sizeof(ulong) * (ushort.MaxValue + 1), ShaderType.VertexShader, ShaderType.FragmentShader);
