...
public static class Glfw {
...
#elif OSX
        public const string LIBRARY = "GLFW/libglfw.3"; // mac
#else
	public const string LIBRARY = "GLFW/glfw";
#endif

	private static readonly ErrorCallback _errorCallback = GlfwError;
	...
	public static void WindowHintStringUTF8( Hint hint, string value ) => WindowHintString( hint, Encoding.UTF8.GetBytes( value ) );
	...
	/// <param name="value">The new value of the window hint.</param>
	// ReSharper disable once InconsistentNaming
	public static void WindowHintStringASCII( Hint hint, string value ) => WindowHintString( hint, Encoding.ASCII.GetBytes( value ) );
	...
	/// <summary>
	///     Gets the window whose OpenGL or OpenGL ES context is current on the calling thread, or <see cref="WindowPtr.None" />
	///     if no context is current.
	/// </summary>
	/// <value>
	///     The current context.
	/// </value>
	public static WindowPtr CurrentContext => GetCurrentContext();
	...
	/// </summary>
	/// <value>
	///     The primary monitor, or <see cref="MonitorPtr.None" /> if no monitors were found or if an error occurred.
	/// </value>
	public static MonitorPtr PrimaryMonitor => GetPrimaryMonitor();
	...
	private static extern WindowPtr CreateWindow( int width, int height, byte[] title, MonitorPtr monitor, WindowPtr share );
	...
	public static extern void DestroyWindow( WindowPtr window );
	...
	public static extern void ShowWindow( WindowPtr window );
	...
	public static extern void HideWindow( WindowPtr window );
	...
	public static extern void GetWindowPosition( WindowPtr window, out int x, out int y );
	...
	public static extern void SetWindowPosition( WindowPtr window, int x, int y );
	...
	public static extern void GetWindowSize( WindowPtr window, out int width, out int height );
	...
	public static extern void SetWindowSize( WindowPtr window, int width, int height );
	...
	public static extern void GetFramebufferSize( WindowPtr window, out int width, out int height );
	...
	public static extern PositionCallback SetWindowPositionCallback( WindowPtr window,
	...
	public static extern SizeCallback SetWindowSizeCallback( WindowPtr window, SizeCallback sizeCallback );
	...
	private static extern void SetWindowTitle( WindowPtr window, byte[] title );
	...
	public static extern void FocusWindow( WindowPtr window );
	...
	public static extern FocusCallback SetWindowFocusCallback( WindowPtr window, FocusCallback focusCallback );
	...
	public static extern void GetWindowFrameSize( WindowPtr window, out int left, out int top, out int right,
		out int bottom );
	...
	public static extern void MaximizeWindow( WindowPtr window );
	...
	public static extern void IconifyWindow( WindowPtr window );
	...
	public static extern void RestoreWindow( WindowPtr window );
	...
	public static extern void MakeContextCurrent( WindowPtr window );
	...
	public static extern void SwapBuffers( WindowPtr window );
	...
	public static extern bool WindowShouldClose( WindowPtr window );
	...
	public static extern void SetWindowShouldClose( WindowPtr window, bool close );
	...
	public static extern void SetWindowIcon( WindowPtr window, int count, Image[] images );
	...
	public static extern WindowCallback SetCloseCallback( WindowPtr window, WindowCallback closeCallback );
	...
	/// </summary>
	/// <param name="window">A window instance.</param>
	/// <returns>The monitor, or <see cref="MonitorPtr.None" /> if the window is in windowed mode or an error occurred.</returns>
	[DllImport( LIBRARY, EntryPoint = "glfwGetWindowMonitor", CallingConvention = CallingConvention.Cdecl )]
	public static extern MonitorPtr GetWindowMonitor( WindowPtr window );

	/// <summary>
	///     Sets the monitor that the window uses for full screen mode or, if the monitor is
	///     <see cref="MonitorPtr.None" />, makes it windowed mode.
	///     <para>
	...
	///     </para>
	///     <para>
	///         When the monitor is <see cref="MonitorPtr.None" />, the position, width and height are used to place the window
	...
	/// </summary>
	/// <param name="window">A window instance.</param>
	/// <param name="monitor">The desired monitor, or <see cref="MonitorPtr.None" /> to set windowed mode.</param>
	...
	public static extern void SetWindowMonitor( WindowPtr window, MonitorPtr monitor, int x, int y, int width, int height,
		int refreshRate );
	...
	public static extern void SetGammaRamp( MonitorPtr monitor, GammaRamp gammaRamp );
	...
	public static extern void SetCursor( WindowPtr window, Cursor cursor );
	...
	public static extern void GetCursorPosition( WindowPtr window, out double x, out double y );
	...
	public static extern void SetCursorPosition( WindowPtr window, double x, double y );
	...
	public static extern MouseCallback SetCursorPositionCallback( WindowPtr window, MouseCallback mouseCallback );
	...
	public static extern MouseEnterCallback SetCursorEnterCallback( WindowPtr window, MouseEnterCallback mouseCallback );
	...
	public static extern MouseButtonCallback SetMouseButtonCallback( WindowPtr window,
	...
	[return: MarshalAs( UnmanagedType.FunctionPtr, MarshalTypeRef = typeof( MouseCallback ) )]
	public static extern MouseCallback SetScrollCallback( WindowPtr window, MouseCallback mouseCallback );
	...
	public static extern InputState GetMouseButton( WindowPtr window, MouseButton button );
	...
	public static extern void SetWindowSizeLimits( WindowPtr window, int minWidth, int minHeight, int maxWidth,
		int maxHeight );
	...
	public static extern void SetWindowAspectRatio( WindowPtr window, int numerator, int denominator );

	[DllImport( LIBRARY, EntryPoint = "glfwGetCurrentContext", CallingConvention = CallingConvention.Cdecl )]
	private static extern WindowPtr GetCurrentContext();
	...
	public static extern void GetMonitorPhysicalSize( MonitorPtr monitor, out int width, out int height );
	...
	public static extern CharCallback SetCharCallback( WindowPtr window, CharCallback charCallback );
	...
	public static extern CharModsCallback SetCharModsCallback( WindowPtr window, CharModsCallback charCallback );
	...
	[return: MarshalAs( UnmanagedType.FunctionPtr, MarshalTypeRef = typeof( SizeCallback ) )]
	public static extern SizeCallback SetFramebufferSizeCallback( WindowPtr window, SizeCallback sizeCallback );
	...
	[return: MarshalAs( UnmanagedType.FunctionPtr, MarshalTypeRef = typeof( WindowCallback ) )]
	public static extern WindowCallback SetWindowRefreshCallback( WindowPtr window, WindowCallback callback );
	...
	public static extern KeyCallback SetKeyCallback( WindowPtr window, KeyCallback keyCallback );
	...
	public static extern IconifyCallback SetWindowIconifyCallback( WindowPtr window, IconifyCallback callback );
	...
	public static extern void SetInputMode( WindowPtr window, InputMode mode, int value );
	...
	public static extern int GetInputMode( WindowPtr window, InputMode mode );
	...
	/// <param name="monitor">The monitor to use for full screen mode, or <see cref="MonitorPtr.None" /> for windowed mode.</param>
	/// <param name="share">
	///     A window instance whose context to share resources with, or <see cref="WindowPtr.None" /> to not share
	///     resources..
	/// </param>
	/// <returns>The created window, or <see cref="WindowPtr.None" /> if an error occurred.</returns>
	public static WindowPtr CreateWindow( int width, int height, string title, MonitorPtr monitor, WindowPtr share ) => CreateWindow( width, height, Encoding.UTF8.GetBytes( title ), monitor, share );
	...
	public static ClientApi GetClientApi( WindowPtr window ) => (ClientApi) GetWindowAttribute( window, (int) ContextAttributes.ClientApi );
	...
	public static string GetClipboardString( WindowPtr window ) => Util.PtrToStringUTF8( GetClipboardStringInternal( window ) );
	...
	public static ContextApi GetContextCreationApi( WindowPtr window ) => (ContextApi) GetWindowAttribute( window, (int) ContextAttributes.ContextCreationApi );
	...
	public static Version GetContextVersion( WindowPtr window ) {
	...
	/// <returns><c>true</c> if the extension is supported; otherwise <c>false</c>.</returns>
	public static bool GetExtensionSupported( string extension ) => GetExtensionSupported( Encoding.ASCII.GetBytes( extension ) );
	...
	public static GammaRamp GetGammaRamp( MonitorPtr monitor ) => (GammaRamp) Marshal.PtrToStructure<GammaRampInternal>( GetGammaRampInternal( monitor ) );
	...
	public static bool GetIsDebugContext( WindowPtr window ) => GetWindowAttribute( window, (int) ContextAttributes.OpenglDebugContext ) == (int) Constants.True;
	...
	public static bool GetIsForwardCompatible( WindowPtr window ) => GetWindowAttribute( window, (int) ContextAttributes.OpenglForwardCompat ) == (int) Constants.True;
	...
	public static string GetJoystickName( Joystick joystick ) => Util.PtrToStringUTF8( GetJoystickNameInternal( joystick ) );
	...
	public static string GetKeyName( Keys key, int scanCode ) => Util.PtrToStringUTF8( GetKeyNameInternal( key, scanCode ) );
	...
	public static string GetMonitorName( MonitorPtr monitor ) => Util.PtrToStringUTF8( GetMonitorNameInternal( monitor ) );
	...
	public static Profile GetProfile( WindowPtr window ) => (Profile) GetWindowAttribute( window, (int) ContextAttributes.OpenglProfile );
	...
	public static Robustness GetRobustness( WindowPtr window ) => (Robustness) GetWindowAttribute( window, (int) ContextAttributes.ContextRobustness );
	...
	public static bool GetWindowAttribute( WindowPtr window, WindowAttribute attribute ) => GetWindowAttribute( window, (int) attribute ) == (int) Constants.True;
	...
	public static void SetClipboardString( WindowPtr window, string str ) => SetClipboardString( window, Encoding.UTF8.GetBytes( str ) );
	...
	public static void SetWindowTitle( WindowPtr window, string title ) => SetWindowTitle( window, Encoding.UTF8.GetBytes( title ) );
	...
	/// <param name="hint">The hint.</param>
	/// <param name="value">The value.</param>
	public static void WindowHint( Hint hint, bool value ) => WindowHint( hint, value ? Constants.True : Constants.False );
	...
	private static void GetContextVersion( WindowPtr window, out int major, out int minor, out int revision ) {
