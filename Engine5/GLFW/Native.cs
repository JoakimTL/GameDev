...
public static class Native {
	...
	public static extern NSOpenGLContext GetNSGLContext( WindowPtr window );
	...
	public static extern OSMesaContext GetOSMesaContext( WindowPtr window );
	...
	public static extern GLXContext GetGLXContext( WindowPtr window );
	...
	public static extern EGLContext GetEglContext( WindowPtr window );
	...
	public static extern EGLSurface GetEglSurface( WindowPtr window );
	...
	public static extern HGLRC GetWglContext( WindowPtr window );
	...
	public static void SetX11SelectionString( string str ) => SetX11SelectionString( Encoding.UTF8.GetBytes( str ) );
	...
	public static string GetWin32Adapter( MonitorPtr monitor ) => Util.PtrToStringUTF8( GetWin32AdapterInternal( monitor ) );
	...
	///     error occurred.
	/// </returns>
	public static string GetWin32Monitor( MonitorPtr monitor ) => Util.PtrToStringUTF8( GetWin32MonitorInternal( monitor ) );
