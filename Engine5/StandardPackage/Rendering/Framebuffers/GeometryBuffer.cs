...
namespace StandardPackage.Rendering.Framebuffers;
public sealed class GeometryBuffer : FrameBuffer
{
    ...
    public GeometryBuffer(Viewport viewport, Window window, float scale = 1) : base(viewport, new WindowProportions(window, scale)) { }
