...
namespace Engine.GLFrameWork
{
    ...
    public enum Hint
    {
		...
		///     <para>This is a hard constraint.</para>
		///     <para>Default Value: <see cref="global::GLFW.ClientApi.OpenGL" /></para>
		///     <para>Possible Values: Any of <see cref="global::GLFW.ClientApi" /> values.</para>
		/// </summary>
