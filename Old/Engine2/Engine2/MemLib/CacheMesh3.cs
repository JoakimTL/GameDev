...
namespace Engine.MemLib {
	public class CacheMesh3 : Cache<string, Mesh3> {
		...
		public void Initialize() {
			Cube = new Mesh3( "cube", 
				new Vertex3[] {
					new Vertex3().SetPosition(new Vector3(-1.0f, -1.0f, -1.0f)).SetUV(new Vector2(0, 0)),
					new Vertex3().SetPosition(new Vector3(-1.0f,  1.0f, -1.0f)).SetUV(new Vector2(0, 1)),
					new Vertex3().SetPosition(new Vector3( 1.0f, -1.0f, -1.0f)).SetUV(new Vector2(1, 0)),

					new Vertex3().SetPosition(new Vector3( 1.0f,  1.0f, -1.0f)).SetUV(new Vector2(1, 1)),
					new Vertex3().SetPosition(new Vector3( 1.0f, -1.0f, -1.0f)).SetUV(new Vector2(1, 0)),
					new Vertex3().SetPosition(new Vector3(-1.0f,  1.0f, -1.0f)).SetUV(new Vector2(0, 1)),
			...
			GLUtil.CheckError( "mesh3 1" );

			BoxY = new Mesh3( "boxY",
				new Vertex3[] {
					new Vertex3().SetPosition(new Vector3(-1.0f,0.0f,-1.0f)),
					new Vertex3().SetPosition(new Vector3(-1.0f,0.0f, 1.0f)),
					new Vertex3().SetPosition(new Vector3(-1.0f, 1.0f, 1.0f)),
					new Vertex3().SetPosition(new Vector3(1.0f, 1.0f,-1.0f)),
					new Vertex3().SetPosition(new Vector3(-1.0f,0.0f,-1.0f)),
					new Vertex3().SetPosition(new Vector3(-1.0f, 1.0f,-1.0f)),
					new Vertex3().SetPosition(new Vector3(1.0f,0.0f, 1.0f)),
			...
			GLUtil.CheckError( "mesh3 2" );

			BoxZ = new Mesh3( "boxZ",
				new Vertex3[] {
					new Vertex3().SetPosition(new Vector3(-1.0f,-1.0f,-1.0f)),
					new Vertex3().SetPosition(new Vector3(-1.0f,-1.0f, 0.0f)),
					new Vertex3().SetPosition(new Vector3(-1.0f, 1.0f, 0.0f)),
					new Vertex3().SetPosition(new Vector3( 1.0f, 1.0f,-1.0f)),
					new Vertex3().SetPosition(new Vector3(-1.0f,-1.0f,-1.0f)),
					new Vertex3().SetPosition(new Vector3(-1.0f, 1.0f,-1.0f)),
