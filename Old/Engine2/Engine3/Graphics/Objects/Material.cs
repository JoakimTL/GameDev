...
namespace Engine.Graphics.Objects {
	public class Material : ICountable {
		...
		public Material AddTextures( ImmutableDuo<TextureUnit, Texture> textureCombo ) {
		...
		public Material AddTexture( TextureUnit tUnit, Texture t ) {
			textures.Add( new ImmutableDuo<TextureUnit, Texture>( tUnit, t ) );
			textureSequence.Add( (uint) tUnit );
			textureSequence.Add( t.TextureID );
			needsAssignment = true;
			return this;
		}
