...
namespace Engine.Graphics.Objects.Default.Lights.D3 {
	public class GLLightSpot {
		...
		public LightSpot Light { get; private set; }
		...
		public GLLightSpot( LightManager lmg, LightSpot light, Scene3Collection scenes ) {
			Light = light;
