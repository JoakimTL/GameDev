...
namespace Engine.Graphics.Objects {
	...
	public delegate void WindowFocusEvent( IntPtr window, bool focused );
	...
	public delegate void WheelScrollChangeEvent( IntPtr window, float delta, MouseInputEventData data );
	#endregion

	#region Interfaces
	public interface IWindowEventListener {
		void WindowResizeHandler( IntPtr window, int width, int height );
		void WindowFocusHandler( IntPtr window, bool focused );
	}
	...
	public interface IEventListener : IWindowEventListener, IKeyboardEventListener, IMouseEventListener { }
	#endregion
	...
	public class InputEventHandler {
		...
		internal void Bind( Window window ) {
			...
			GLFW.SetWindowFocusCallback( window, Window.WindowFocusCallback );
	...
	public class WindowInputEventManager {
		...
		public SizeCallback WindowResizeCallback { get; private set; }
		public WindowMaximizedCallback WindowMaximizeCallback { get; internal set; }
		public FocusCallback WindowFocusCallback { get; internal set; }

		public WindowInputEventManager() {
			WindowResizeCallback = new SizeCallback( WindowResized );
			WindowFocusCallback = new FocusCallback( WindowFocused );
		}

		#region Events

		public event WindowResizeEvent Resize;
		public event WindowFocusEvent Focused;

		public void Add( IWindowEventListener e ) {
			Resize += e.WindowResizeHandler;
			Focused += e.WindowFocusHandler;
		}

		public void Remove( IWindowEventListener e ) {
			Resize -= e.WindowResizeHandler;
			Focused -= e.WindowFocusHandler;
		}
		...
		internal void WindowFocused( IntPtr window, bool focusing ) {
			Focused?.Invoke( window, focusing );
		}
	}
	#endregion
}
