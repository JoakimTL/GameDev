...
namespace Engine.QuickstartKit {
	public class QSCameraHandler : IMouseEventListener, IKeyboardEventListener {

		private QuickstartClientRender qscr;

		public QSCameraHandler( QuickstartClientRender qscr ) {
			this.qscr = qscr;
			qscr.Window.EventHandler.Keyboard.Add( this );
			qscr.Window.EventHandler.Mouse.Add( this );
			qscr.Render3.PreRenderPipeline.InsertLast( new Pipelines.Junction( "QSCameraHandler", () => { CameraUpdate(); } ) );
		}
