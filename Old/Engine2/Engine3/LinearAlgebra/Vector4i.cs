...
namespace Engine.LinearAlgebra {
	...
	public struct Vector4i : System.IEquatable<Vector4i> {
		...
		public Vector4b AsByte => new Vector4b( (byte) X, (byte) Y, (byte) Z, (byte) W );
		...
		public Vector4i( byte[] data ) : this( DataTransform.ToInt32Array( data ) ) { }
		...
		public static implicit operator Vector4i( (int, int, int, int) a ) {
			return new Vector4i( a.Item1, a.Item2, a.Item3, a.Item4 );
		}
