...
//		Button b = new(Resources.Render.FontManager.Get("calibri"), "test");
//		b.Activate();
//		//Resources.Render.Get<UIManager>().Add( b );
//		for ( int i = 0; i < 10; i++ ) {
//			Label lbl = new( new Font( "res/textures/fonts/calibri" ), "The quick brown fox jumps over the lazy dog.", 0.03f );
//			lbl.Container.SetAlignment( HorizontalAlignment.CENTER );
//			int j = i;
//			lbl.SetConstraint( ( float time, float dt, Transform2 t ) =>
//			{
//				t.Translation = new Vector2( 0, 1 - j * 0.2f );
//				t.Rotation =0;
//				t.Scale = new Vector2( j + 1 );
//			} );
//			lbl.Activate();
