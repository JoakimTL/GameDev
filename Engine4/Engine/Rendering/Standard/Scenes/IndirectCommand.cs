...
public struct IndirectCommand {
	...
	/// <summary>
	/// First element index, the start of the element segment. This is in n-bytes, as the size per element is decided using the draw call. Usually <see cref="OpenGL.DrawElementsType.UnsignedInt"/> is used.
	/// </summary>
	[FieldOffset( 8 )]
