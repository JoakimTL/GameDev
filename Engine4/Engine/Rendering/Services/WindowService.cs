...
[Structure.ProcessBefore( typeof( OglService ), typeof( IDisposable ) )]
[Structure.ProcessAfter( typeof( OglService ), typeof( IInitializable ) )]
[Structure.RequireService( typeof( OglService ) )]
public class WindowService : ModuleService, IInitializable {
	...
	public void Initialize() => this.Window = new Window( this.Settings );
