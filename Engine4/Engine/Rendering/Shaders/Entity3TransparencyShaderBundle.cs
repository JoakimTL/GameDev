...
public class Entity3TransparencyShaderBundle : ShaderBundle {
	public Entity3TransparencyShaderBundle() : base( 
		(0, Resources.Render.Shader.Pipelines.GetOrAdd<Entity3TransparencyShader>()),
		(1, Resources.Render.Shader.Pipelines.GetOrAdd<Entity3DirectionalTransparencyShader>())
	) { }
