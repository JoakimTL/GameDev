...
public class DirectionalLightShaderBundle : ShaderBundle {
	public DirectionalLightShaderBundle() : base( "DirectionalNoShadowLight", (0, Resources.Render.Shader.Pipelines.Get<DirectionalLightShader>()) ) { }
...
public class DirectionalShadowedLightShaderBundle : ShaderBundle {
	public DirectionalShadowedLightShaderBundle() : base( "DirectionalShadowLight", (0, Resources.Render.Shader.Pipelines.Get<DirectionalShadowedLightShader>()) ) { }
	public override bool UsesTransparency => true;
}
