...
layout(location = 10) in uint64_t iDiffuseTexture;
layout(location = 11) in uint64_t iNormalTexture;
layout(location = 12) in uint64_t iLightingTexture;
layout(location = 13) in uint64_t iGlowTexture;
