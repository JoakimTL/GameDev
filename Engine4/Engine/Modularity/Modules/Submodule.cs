...
public abstract class Submodule : DisposableIdentifiable, IRemovable, IUpdateable {
	...
	public event Action<IRemovable>? Removed;
	...
	protected T Singleton<T>() where T : ModuleSingletonBase => this.Parent.Singleton<T>();
