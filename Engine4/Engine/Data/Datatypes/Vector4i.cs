...
public struct Vector4i {
	...
	public Vector4i Negate() => new( -this.X, -this.Y, -this.Z, -this.W );
	public override string ToString() => $"Vector4i[{this.X},{this.Y},{this.Z},{this.W}]";
	public bool Equals( Vector4i other ) => this.X == other.X && this.Y == other.Y && this.Z == other.Z && this.W == other.W;
	public override bool Equals( object? obj ) => obj is Vector4i v && Equals( v );
	public override int GetHashCode() => this.X ^ this.Y ^ this.Z ^ this.W;
	#endregion

	#region Properties
	public Vector2i XY => new( this.X, this.Y );
	public Vector3i XYZ => new( this.X, this.Y, this.Z );
	public Vector4 AsFloat => new( this.X, this.Y, this.Z, this.W );
	#endregion
