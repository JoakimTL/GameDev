...
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void SizeCallback( WindowPtr window, int width, int height );
...
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void PositionCallback( WindowPtr window, double x, double y );
...
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void FocusCallback( WindowPtr window, bool focusing );
...
/// <param name="window">The window handle.</param>
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void WindowCallback( WindowPtr window );
...
/// <param name="y">The new cursor y-coordinate, relative to the left edge of the client area.</param>
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void MouseCallback( WindowPtr window, double x, double y );
...
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void MouseEnterCallback( WindowPtr window, bool entering );
...
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void MouseButtonCallback( WindowPtr window, MouseButton button, InputState state,
...
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void CharModsCallback( WindowPtr window, uint codePoint, ModifierKeys mods );
...
/// <param name="mods">	Bit field describing which modifier keys were held down.</param>
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void KeyCallback( WindowPtr window, Keys key, int scanCode, InputState state, ModifierKeys mods );
...
/// <param name="status">The connection status.</param>
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void MonitorCallback( MonitorPtr monitor, ConnectionStatus status );
...
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void WindowContentsScaleCallback( WindowPtr window, float xScale, float yScale );
...
[UnmanagedFunctionPointer( CallingConvention.Cdecl )]
public delegate void WindowMaximizedCallback( WindowPtr window, bool maximized );
