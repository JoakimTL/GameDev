...
public readonly struct Multivector3<TScalar>( TScalar scalar, Vector3<TScalar> vector, Bivector3<TScalar> bivector, Trivector3<TScalar> trivector ) :
	...
	public TScalar MagnitudeSquared() => (Scalar * Scalar) + Vector.MagnitudeSquared() + Bivector.MagnitudeSquared() + Trivector.MagnitudeSquared();
	...
	public override string ToString()
		=> $"<{Scalar.ToFormattedString( true )} + {Vector} + {Bivector} + {Trivector}>";
