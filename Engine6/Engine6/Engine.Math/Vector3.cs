...
public readonly struct Vector3<TScalar>( TScalar x, TScalar y, TScalar z ) :
	...
	public bool GreaterThanEntrywise( in Vector3<TScalar> other ) => X > other.X && Y > other.Y && Z > other.Z;
	public bool GreaterThanOrEqualEntrywise( in Vector3<TScalar> other ) => X >= other.X && Y >= other.Y && Z >= other.Z;
	...
	public override string ToString()
		=> $"[{X.ToFormattedString( true )}X {Y.ToFormattedString()}Y {Z.ToFormattedString()}Z]";
