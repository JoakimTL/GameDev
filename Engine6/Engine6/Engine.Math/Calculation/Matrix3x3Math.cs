...
public sealed class Matrix3x3Math<T> :
		...
		IMatrixDeterminant<Matrix3x3<T>, T>
	where T :
		unmanaged, INumber<T> {
	...
	[MethodImpl( MethodImplOptions.AggressiveInlining )]
	public static T GetDeterminant( in Matrix3x3<T> m )
		=> m.Excluding00.GetDeterminant() * m.M00
		- m.Excluding10.GetDeterminant() * m.M10
		+ m.Excluding20.GetDeterminant() * m.M20;
}
