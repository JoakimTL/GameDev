...
public readonly struct Vector2<TScalar>( TScalar x, TScalar y ) :
	...
	public bool GreaterThanEntrywise( in Vector2<TScalar> other ) => X > other.X && Y > other.Y;
	public bool GreaterThanOrEqualEntrywise( in Vector2<TScalar> other ) => X >= other.X && Y >= other.Y;
	...
	public override string ToString()
		=> $"[{X.ToFormattedString( true )}X {Y.ToFormattedString()}Y]";
