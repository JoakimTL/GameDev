...
public sealed class Multivector3Math<T> :
		...
		IGeometricProduct<Vector3<T>, Vector3<T>, Multivector3<T>>,             // 1*1
		IGeometricProduct<Vector3<T>, Bivector3<T>, Multivector3<T>>,           // 1*2
		IGeometricProduct<Vector3<T>, Multivector3<T>, Multivector3<T>>,        // 1*4
		IGeometricProduct<Bivector3<T>, Vector3<T>, Multivector3<T>>,           // 2*1
		IGeometricProduct<Bivector3<T>, Bivector3<T>, Multivector3<T>>,         // 2*2
		IGeometricProduct<Bivector3<T>, Multivector3<T>, Multivector3<T>>,      // 2*4
		IGeometricProduct<Trivector3<T>, Multivector3<T>, Multivector3<T>>,     // 3*4
		IGeometricProduct<Multivector3<T>, Vector3<T>, Multivector3<T>>,        // 4*1
		IGeometricProduct<Multivector3<T>, Bivector3<T>, Multivector3<T>>,      // 4*2
		IGeometricProduct<Multivector3<T>, Trivector3<T>, Multivector3<T>>,     // 4*3
		IGeometricProduct<Multivector3<T>, Multivector3<T>, Multivector3<T>>    // 4*4
	where T :
	...
	[MethodImpl( MethodImplOptions.AggressiveInlining )]
	public static Multivector3<T> Multiply( in Vector3<T> l, in Vector3<T> r )
		=> new(
	...
	[MethodImpl( MethodImplOptions.AggressiveInlining )]
	public static Multivector3<T> Multiply( in Bivector3<T> l, in Bivector3<T> r )
		=> new(
	...
	public static Multivector3<T> Multiply( in Vector3<T> l, in Multivector3<T> r )
		=> new(
			...
			l.X * r.Scalar + l.Z * r.Bivector.ZX - l.Y * r.Bivector.XY,
			l.X * r.Bivector.XY + l.Y * r.Scalar - l.Z * r.Bivector.YZ,
			l.Y * r.Bivector.YZ + l.Z * r.Scalar - l.X * r.Bivector.ZX,
			l.X * r.Trivector.XYZ + l.Y * r.Vector.Z - l.Z * r.Vector.Y,
	...
	public static Multivector3<T> Multiply( in Bivector3<T> l, in Multivector3<T> r )
		=> new(
			...
			l.YZ * r.Vector.Z - l.XY * r.Vector.X - l.ZX * r.Trivector.XYZ,
			...
			l.XY * r.Scalar + l.ZX * r.Bivector.YZ - l.YZ * r.Bivector.ZX,
	...
	public static Multivector3<T> Multiply( in Multivector3<T> l, in Multivector3<T> r )
		=> new(
			...
			l.Scalar * r.Vector.X + l.Vector.X * r.Scalar + l.Vector.Z * r.Bivector.ZX + l.Bivector.XY * r.Vector.Y - l.Vector.Y * r.Bivector.XY - l.Bivector.YZ * r.Trivector.XYZ - l.Bivector.ZX * r.Vector.Z - l.Trivector.XYZ * r.Bivector.YZ,
			l.Scalar * r.Vector.Y + l.Vector.X * r.Bivector.XY + l.Vector.Y * r.Scalar + l.Bivector.YZ * r.Vector.Z - l.Vector.Z * r.Bivector.YZ - l.Bivector.XY * r.Vector.X - l.Bivector.ZX * r.Trivector.XYZ - l.Trivector.XYZ * r.Bivector.ZX,
			...
			l.Scalar * r.Bivector.YZ + l.Vector.X * r.Trivector.XYZ + l.Vector.Y * r.Vector.Z + l.Bivector.XY * r.Bivector.ZX + l.Bivector.YZ * r.Scalar + l.Trivector.XYZ * r.Vector.X - l.Vector.Z * r.Vector.Y - l.Bivector.ZX * r.Bivector.XY,
			...
			l.Scalar * r.Bivector.XY + l.Vector.X * r.Vector.Y + l.Vector.Z * r.Trivector.XYZ + l.Bivector.XY * r.Scalar + l.Bivector.ZX * r.Bivector.YZ + l.Trivector.XYZ * r.Vector.Z - l.Vector.Y * r.Vector.X - l.Bivector.YZ * r.Bivector.ZX,
