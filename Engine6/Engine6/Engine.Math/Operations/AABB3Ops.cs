...
public sealed class AABB3Ops<T> :
	...
	public static IEnumerable<Vector3<T>> GetPointsInAreaExclusive( AABB3<T> aabb, T increment, Rotor3<T> planeRotor, T planeDistanceFromOrigin ) {
		throw new NotImplementedException();
	}

	public static IEnumerable<Vector3<T>> GetPointsInAreaInclusive( AABB3<T> aabb, T increment, Rotor3<T> planeRotor, T planeDistanceFromOrigin ) {
		throw new NotImplementedException();
	}

	public static IEnumerable<Vector3<T>> GetPointsInAreaExclusiveExcept( AABB3<T> aabb, AABB3<T> other, T increment, Rotor3<T> planeRotor, T planeDistanceFromOrigin ) {
		throw new NotImplementedException();
	}

	public static IEnumerable<Vector3<T>> GetPointsInAreaIncusiveExcept( AABB3<T> aabb, AABB3<T> other, T increment, Rotor3<T> planeRotor, T planeDistanceFromOrigin ) {
		throw new NotImplementedException();
	}
