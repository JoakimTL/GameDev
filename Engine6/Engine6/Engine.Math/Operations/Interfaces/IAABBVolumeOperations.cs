...
public interface IAABBVolumeOperations<T, TRotor, TVector, TScalar> where T : unmanaged where TRotor : unmanaged where TVector : unmanaged where TScalar : unmanaged, INumber<TScalar> {
	...
	static abstract IEnumerable<TVector> GetPointsInAreaExclusive( T aabb, TScalar increment, TRotor planeRotor, TScalar planeDistanceFromOrigin );
	static abstract IEnumerable<TVector> GetPointsInAreaInclusive( T aabb, TScalar increment, TRotor planeRotor, TScalar planeDistanceFromOrigin );
	static abstract IEnumerable<TVector> GetPointsInAreaExclusiveExcept( T aabb, T other, TScalar increment, TRotor planeRotor, TScalar planeDistanceFromOrigin );
	static abstract IEnumerable<TVector> GetPointsInAreaIncusiveExcept( T aabb, T other, TScalar increment, TRotor planeRotor, TScalar planeDistanceFromOrigin );
