...
public sealed class Matrix4x4FactoryTests {
	...
	public void CreatePerspectiveFieldOfView() {
		...
		Matrix4x4<float> result = Matrix.Create4x4.PerspectiveFieldOfView( fov, aspect, near, far );
	...
	public void CreatePerspective() {
		...
		Matrix4x4<float> result = Matrix.Create4x4.Perspective( left, top, right, bottom, near, far );
	...
	public void CreateScaling_2d_Scalars() {
		...
		Matrix4x4<float> result = Matrix.Create4x4.Scaling( x, y );
	...
	public void CreateScaling_2d_Vector() {
		...
		Matrix4x4<float> result = Matrix.Create4x4.Scaling( new Vector2<float>( x, y ) );
	...
	public void CreateScaling_3d_Scalars() {
		...
		Matrix4x4<float> result = Matrix.Create4x4.Scaling( x, y, z );
	...
	public void CreateScaling_3d_Vector() {
		...
		Matrix4x4<float> result = Matrix.Create4x4.Scaling( new Vector3<float>( x, y, z ) );
	...
	public void CreateTranslation_2d_Scalars() {
		...
		Matrix4x4<float> result = Matrix.Create4x4.Translation( x, y );
	...
	public void CreateTranslation_2d_Vector() {
		...
		Matrix4x4<float> result = Matrix.Create4x4.Translation( new Vector2<float>( x, y ) );
	...
	public void CreateTranslation_3d_Scalars() {
		...
		Matrix4x4<float> result = Matrix.Create4x4.Translation( x, y, z );
	...
	public void CreateTranslation_3d_Vector() {
		...
		Matrix4x4<float> result = Matrix.Create4x4.Translation( new Vector3<float>( x, y, z ) );
