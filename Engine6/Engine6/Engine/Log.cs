...
public static class Log {
	...
	public static void LogLine( this object o, string text, Level logLevel, ConsoleColor color = ConsoleColor.Gray, int stackLevel = -1, bool logToConsole = true ) => Line( $"{o}: {text}", logLevel, color, stackLevel, logToConsole );
	public static void LogText( this object o, string text, Level logLevel, ConsoleColor color = ConsoleColor.Gray, int stackLevel = -1, bool logToConsole = true ) => Text( $"{o}: {text}", logLevel, color, stackLevel, logToConsole );
