...
public struct AABB2i {
	...
	public uint AreaExclusive => (uint) ( ( this._max.X - this._min.X ) * ( this._max.Y - this._min.Y ) );
	public uint AreaInclusive => (uint) ( ( this._max.X - this._min.X + 1 ) * ( this._max.Y - this._min.Y + 1 ) );
