...
public class OglMipmappedTexture( string name, TextureTarget target, Vector2i level0, uint levels, InternalFormat format, params (TextureParameterName, int)[] parameters )
