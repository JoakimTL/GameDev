...
public readonly struct Trivector3<TScalar>( TScalar xyz ) :
	...
	public Trivector3<TScalar> Negate() => new( -this.XYZ );
	public Trivector3<TScalar> Add( in Trivector3<TScalar> r ) => new( this.XYZ + r.XYZ );
	public Trivector3<TScalar> Subtract( in Trivector3<TScalar> r ) => new( this.XYZ - r.XYZ );
	public Trivector3<TScalar> ScalarMultiply( TScalar r ) => new( this.XYZ * r );
	public Trivector3<TScalar> ScalarDivide( TScalar r ) => new( this.XYZ / r );
	public static Trivector3<TScalar> DivideScalar( TScalar l, in Trivector3<TScalar> r ) => new( l / r.XYZ );
	public TScalar Dot( in Trivector3<TScalar> r ) => -this.XYZ * r.XYZ;
	public TScalar MagnitudeSquared() => this.XYZ * this.XYZ;
	...
	public override int GetHashCode() => HashCode.Combine( this.XYZ );
	public override string ToString()
		=> $"[{this.XYZ.ToFormattedString( true )}XYZ]";
}
