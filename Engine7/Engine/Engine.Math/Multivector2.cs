...
public readonly struct Multivector2<TScalar>( TScalar scalar, Vector2<TScalar> vector, Bivector2<TScalar> bivector ) :
	...
	public Multivector2<TScalar> Negate() => new( -this.Scalar, -this.Vector, -this.Bivector );
	public Multivector2<TScalar> Add( in Multivector2<TScalar> r ) => new( this.Scalar + r.Scalar, this.Vector + r.Vector, this.Bivector + r.Bivector );
	public Multivector2<TScalar> Subtract( in Multivector2<TScalar> r ) => new( this.Scalar - r.Scalar, this.Vector - r.Vector, this.Bivector - r.Bivector );
	...
	public override int GetHashCode() => HashCode.Combine( this.Scalar, this.Vector, this.Bivector );
	public override string ToString()
		=> $"<{this.Scalar.ToFormattedString( true )} + {this.Vector} + {this.Bivector}>";
