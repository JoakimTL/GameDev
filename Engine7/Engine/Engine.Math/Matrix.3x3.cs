...
public static partial class Matrix {
	public static class Create3x3 {
		...
		/// <param name="zBasis">The basis vector representing the z-axis on the vector.</param>
		/// <returns></returns>
		public static Matrix3x3<TScalar> TransposedBasis<TScalar>( in Vector3<TScalar> xBasis, in Vector3<TScalar> yBasis, in Vector3<TScalar> zBasis )
			where TScalar :
				unmanaged, INumber<TScalar>
			=> new( xBasis.X, xBasis.Y, xBasis.Z, yBasis.X, yBasis.Y, yBasis.Z, zBasis.X, zBasis.Y, zBasis.Z );
	}
}