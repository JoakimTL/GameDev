...
public readonly struct Bivector2<TScalar>( TScalar xy ) :
	...
	public Bivector2<TScalar> Negate() => new( -this.XY );
	public Bivector2<TScalar> Add( in Bivector2<TScalar> r ) => new( this.XY + r.XY );
	public Bivector2<TScalar> Subtract( in Bivector2<TScalar> r ) => new( this.XY - r.XY );
	public Bivector2<TScalar> ScalarMultiply( TScalar r ) => new( this.XY * r );
	public Bivector2<TScalar> ScalarDivide( TScalar r ) => new( this.XY / r );
	public static Bivector2<TScalar> DivideScalar( TScalar l, in Bivector2<TScalar> r ) => new( l / r.XY );
	public TScalar Dot( in Bivector2<TScalar> r ) => -this.XY * r.XY;
	public TScalar MagnitudeSquared() => this.XY * this.XY;
	...
	public override int GetHashCode() => HashCode.Combine( this.XY );
	public override string ToString()
		=> $"[{this.XY.ToFormattedString( true )}XY]";
