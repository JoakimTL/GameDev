...
public readonly struct Rotor3<TScalar>( TScalar scalar, Bivector3<TScalar> bivector ) :
	...
	public static Rotor3<TScalar> MultiplicativeIdentity => new( TScalar.One, Bivector3<TScalar>.Zero );
	...
	public Vector3<TScalar> Forward => Rotate( -Vector3<TScalar>.UnitZ );
	public Vector3<TScalar> Left => Rotate( -Vector3<TScalar>.UnitX );
	public Vector3<TScalar> Up => Rotate( Vector3<TScalar>.UnitY );

	public Multivector3<TScalar> GetMultivector() => new( this.Scalar, Vector3<TScalar>.Zero, this.Bivector, Trivector3<TScalar>.Zero );

	public Rotor3<TScalar> Negate() => new( -this.Scalar, -this.Bivector );
	public Rotor3<TScalar> Add( in Rotor3<TScalar> r ) => new( this.Scalar + r.Scalar, this.Bivector + r.Bivector );
	public Rotor3<TScalar> Subtract( in Rotor3<TScalar> r ) => new( this.Scalar - r.Scalar, this.Bivector - r.Bivector );
	...
	public bool TryGetInverse( out Rotor3<TScalar> rotor ) {
		Rotor3<TScalar> conjugate = Conjugate();
	...
	public override int GetHashCode() => HashCode.Combine( this.Scalar, this.Bivector );
	public override string ToString()
		=> $"<{this.Scalar.ToFormattedString( true )} + {this.Bivector}>";
