...
public interface IServiceCatalog {
	...
	/// If the contract type has been registered as a contract in the <see cref="IServiceLibrary"/>, the contract's implementation type will be returned.<br/>
	...
	/// <summary>
	/// Adds the type to a list of services to be automatically initialized when the <see cref="IServiceProvider"/> is instantiated.
	/// </summary>
	/// <typeparam name="T"></typeparam>
