...
public sealed class CivsGameLogicModule : ModuleBase {
	...
	private void MessageReceived( Message message ) {
		...
		if (message.Content is CreateNewWorldRequestMessage createNewWorldRequest) {
			ProceduralWorldTerrainGenerator procGen = new ProceduralWorldTerrainGenerator( createNewWorldRequest.Parameters );
			GlobeModel globe = new GlobeModel( Guid.NewGuid(), createNewWorldRequest.Parameters.Subdivisions, procGen );
