...
public readonly struct EdgeIndices : IEquatable<EdgeIndices> {
	...
	public override int GetHashCode() => HashCode.Combine( VertexA, VertexB );
	public override bool Equals( object? obj ) => obj is EdgeIndices edge && Equals( edge );
	public override string ToString() => $"({VertexA}, {VertexB})";
	public bool Equals( EdgeIndices other ) => VertexA == other.VertexA && VertexB == other.VertexB;
