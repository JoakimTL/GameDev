...
//	public Tile( UnmanagedStaticContainer<Vector3<float>> vectors, double simulatedSurfaceArea, uint tileId, TileIndices indices ) {
//		this.Id = tileId;
...
//	public Vector3<float> VectorC => Vectors.Get( Indices.C );
