...
public sealed class TileClusterSceneInstance() : SceneInstanceBase( typeof( Entity3SceneData ) ) {
	public void UpdateMesh( IReadOnlyList<Tile> tiles, MeshProvider meshProvider ) {
		Mesh?.Dispose();
		SetMesh( CreateMesh( tiles, meshProvider ) );
	}
