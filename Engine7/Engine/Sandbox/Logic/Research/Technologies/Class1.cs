...
//public sealed class ImprovedFire() : TechnologyBase( "Improved Fire", TechnologyKind.Improvement, 25 ) {
//	public override float GetDiscoveryChanceModifier( TechnologyResearcher techHolder ) => 1;
//	public override float GetDiscoveryProgressionModifier( TechnologyResearcher techHolder ) => 1;
//	public override bool HasPrerequisites( TechnologyResearcher techHolder ) => techHolder.GetResearchFor<Fire>().ResearchCompleted;
//}
