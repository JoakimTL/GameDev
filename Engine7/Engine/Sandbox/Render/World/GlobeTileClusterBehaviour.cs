...
public sealed class GlobeTileClusterBehaviour : DependentRenderBehaviourBase<GlobeArchetype>, IInitializable {
	private readonly List<TileRenderCluster> _renderClusters = [];

	public IReadOnlyList<TileRenderCluster> RenderClusters => _renderClusters;
	...
	public override void Update( double time, double deltaTime ) {
		...
		foreach (TileRenderCluster cluster in _renderClusters)
