...
//}
public sealed class DebugFontGlyph : IGlyph {
	...
	public DebugFontGlyph( FontGlyphHeader header, GlyphMap mapping, (Vector2<int> coordinate, bool onCurve)[] points, ushort[] endPointsOfContours ) {
		this.Header = header;
