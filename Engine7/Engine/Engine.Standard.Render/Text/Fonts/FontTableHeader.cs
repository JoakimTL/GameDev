...
public readonly struct FontTableHeader( uint tag, uint checksum, uint offset, uint length ) {
	...
	public FontTableHeader ProperEndianness => new( this.Tag, this.Checksum.FromBigEndian(), this.Offset.FromBigEndian(), this.Length.FromBigEndian() );
