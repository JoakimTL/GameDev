...
//public sealed class OglSegementedBuffer( BufferUsage usage, uint sizeBytes, BufferAutoResizeMode bufferAutoResizeMode ) : OglBufferBase( usage, sizeBytes ) {

//	private readonly List<OglBufferSegment> _segments = [];
//	private readonly BufferAutoResizeMode _bufferAutoResizeMode = bufferAutoResizeMode;
...
//				//There is a gap, we need to move the data
