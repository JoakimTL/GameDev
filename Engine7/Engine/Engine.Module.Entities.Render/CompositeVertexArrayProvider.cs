...
public sealed class CompositeVertexArrayProvider( CompositeVertexArrayObjectService compositeVertexArrayObjectService ) {
	...
	internal OglVertexArrayObjectBase? GetVertexArray<TVertexData, TSceneInstanceData>() where TVertexData : unmanaged where TSceneInstanceData : unmanaged => _compositeVertexArrayObjectService.Get( [ typeof( TVertexData ), typeof( TSceneInstanceData ) ] );
}
