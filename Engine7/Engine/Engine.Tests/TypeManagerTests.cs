...
public class TypeManagerTests {
	...
	public void TestNonGenericSubclasses() {
		IEnumerable<Type> types = TypeManager.Registry.GetAllNonAbstractSubclassesOf( typeof( BaseType ) );
		CollectionAssert.AreEqual( new[] { typeof( Implementation ), typeof( Implementation2 ) }, types );
	}

	[Test]
	public void TestGenericSubclasses() {
		IEnumerable<Type> types = TypeManager.Registry.GetAllNonAbstractSubclassesOf( typeof( FirstLayerBaseTypeGeneric<> ) );
		...
		types = TypeManager.Registry.GetAllNonAbstractSubclassesOf( typeof( SecondLayerBaseTypeGeneric<> ) );
